...
#remove all bacterial spots from MA
				setwd("C:/Dropbox/Workshop2013/Work/R/microarrays/")
				x <- read.table("CUST.tt.txt", sep="\t", header=T)
				MA <- MA[! MA$genes$ProbeName %in% x$x,]
